...
const ToConfirmation = () => {
     ...
     useEffect(() => {
          axios.get(`https://birdtradingplatformapi.azurewebsites.net/api/Order/ToConFirmOfuserId/2`, {
               headers: {
                                   ...
                                   <div>
                                        <div className="toPay-nameShop">
                                             ...
                                             <div className="toPay-Product-text">
                                                  ...
                                                  <div className="toPay-subitem-text" style={{ color: 'red' }}>Chờ Xác Nhận</div>
                                             </div>
                                        </div>
                                   </div>
